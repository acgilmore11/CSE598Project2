...
class DeviceRecordContract extends Contract {
  ...
  async unknownTransaction(ctx) {
    // GRADED FUNCTION
    if (!this[ctx.stub.getFunctionAndParameters().fcn])
  ...
  async queryByCompany(ctx, company) {
    ...
    const query = {
      ...
      use_index: "./META-INF/statedb/couchdb/indexes/companyIndex",
    };
  ...
  async queryByDevice_Type(ctx, device_type) {
        ...
        const query = {
          ...
          use_index: "./META-INF/statedb/couchdb/indexes/device_typeIndex",
        };
